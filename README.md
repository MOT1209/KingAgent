...
[docs/research.md](docs/research.md). The skill ecosystem — how KingAgent
discovers, validates, governs and evaluates the capabilities it uses, and how
MCP servers are classified before their tools reach an agent — is in
