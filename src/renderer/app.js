...
import { feedNameDraft, adoptTitle, shouldPushName } from './session-name.mjs';
...
import { isFile as isFilePanel, isSession as isSessionPanel, ownerFor, keep as keepFile, splitAfter, splitLayout } from './desk-view.mjs';
...
const panelLifecycle = createPanelLifecycle({ api, state: S, tiles: tileEls, toast, uid, code2, baseNameOf, shortHome, q, shorten,
  // renderRail/renderHeader are thunks: they now live in workspace-library.mjs,
  // constructed after this module — same reasoning as the browsers thunks below.
  renderGrid, renderRail: (...a) => renderRail(...a), renderHeader: (...a) => renderHeader(...a), renderAll, syncSplitLayout, openPeek, openCard, refreshTileHead, clearAttention,
  browsers: {
...
const browsers = createBrowserPane({ api, state: S, tiles: tileEls, uid, esc, helpIcon, isFile: isFilePanel, isSession: isSessionPanel,
  ...
  selection: openSelectionDraft, insertAnnotation, sessions: () => S.panels.filter(isSessionPanel).filter(p=>!p.exited), panelIcon:panelChip, settings: (...a) => openSettings(...a), closePanel, dictation: { start: startAnnotationDictation },
...
const termLinks = createTerminalLinkTracking({ api, state: S, q, tiles: tileEls, terminalHint, toast, shorten,
  // showMenu is a thunk for the same reason as renderRail/renderHeader above.
  openSelectionDraft, showMenu: (...a) => showMenu(...a), browsers, setView, openFile, confirmOutsideOpen, REVEAL_LABEL });
...
const launcher = createLauncher({ api, state: S, tiles: tileEls, browsers, toast, overlay, closeOverlay, renderOverlay, rememberHelpFocus,
  ...
  // workspace-library.mjs, constructed after this module, same reasoning as
  // panelLifecycle's browsers thunks.
  refreshTileHead, refreshRail: (...a) => refreshRail(...a), renderRail: (...a) => renderRail(...a), renderHeader: (...a) => renderHeader(...a),
  renderGrid, renderAll, attachCompanion, EVERGREEN_ROWS,
  watchProject: (...a) => watchProject(...a), refreshServices: (...a) => refreshServices(...a), makeFolderDialog,
