...
// Delivered copies carry this marker so sweepCopies can tell its own work from
// a hand-made file. The string changed with the brand rename; isDelivered only
// matches the new form, so copies an older build delivered are treated as
// hand-made — read, never swept. That is the safe direction.
const MARKER_HEAD = 'made by KingAgent from agents/';
