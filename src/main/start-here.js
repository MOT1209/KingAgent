// The note KingAgent leaves in a folder it made for you.
//
...
// the file tree, it opens in KingAgent's own viewer, and the newcomer's first ask can
...
This is **${name}**, the folder you just gave KingAgent.

KingAgent can read and change things in here, and nowhere else on your computer.
That is the whole safety model, and it is why every session asks you for a
folder first.

## KingAgent runs agents. It isn't one.

KingAgent is the desk. The thinking is done by an agent: Claude Code, Codex and
a few others. Each one signs in with **your own account**, so there is no
KingAgent account and no second bill. If you have none installed yet, press
...
You can delete this file whenever you like. It is yours now, and KingAgent will
not put it back.
`;
}
